        ...
        <>
            <header className="relative z-50">
                ...
                {location.pathname === '/' &&
                    <>
                        {/* Overlay Text */}
                        <div className="absolute inset-0 z-20 flex justify-center items-end pointer-events-none py-6">
                            <div className="p-4 text-center rounded bg-black/30 backdrop-blur-md flex flex-col space-y-6 w-11/12 md:w-3/5 mx-auto pointer-events-auto text-white">
                                <p className="text-2xl font-semibold text-orange-400 uppercase">
                                    “It always seems impossible, until it’s done.”
                                </p>
                                <h1 className="text-4xl md:text-5xl font-bold leading-14 text-shadow-2xs text-shadow-amber-500">
                                    Top-Rated Luxury Event Management Company in Delhi NCR
                                </h1>
                                <p className="text-gray-300 w-[85%] mx-auto tracking-widest">
                                ...
                                {/* <div> */}
                                <Button name={'Contact Us'} onClick={() => alert('My World')} />
                                {/* </div> */}
                            </div>
                        </div>
                        <ImageCarousel />
